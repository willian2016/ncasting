...
--
-- Host: 127.0.0.1
-- Generation Time: 26-Abr-2017 às 01:31
...
INSERT INTO `contatos` (`id`, `emailprinc`, `emailsecundario`, `cel`, `telcontato`, `skype`, `telresi`, `site`) VALUES
(77, ' willian.fink@gmail.com', 'willian.fink@gmail.com', '999999999cel', '1159748543', 'nao tem skype', '1159748543', 'wwwwwwwwwwwwwwwwwwwwwww'),
(78, ' willian.fink@gmail.com', 'willian.fink@gmail.com', '', '1159748543', '', '1159748543', '');
...
CREATE TABLE `dadospessoais` (
  ...
  `etinia` varchar(100) NOT NULL,
  `nacionalidade` varchar(50) NOT NULL,
  `acendencia` varchar(50) NOT NULL,
  `atuacao` varchar(50) NOT NULL,
  `drt` varchar(10) NOT NULL,
  `profissao` varchar(150) NOT NULL,
  `cidatual` varchar(50) NOT NULL,
  `ufatual` varchar(50) NOT NULL,
  `cidadenatal` varchar(50) NOT NULL,
  `ufnatal` varchar(50) NOT NULL,
...
INSERT INTO `dadospessoais` (`id`, `idendereco`, `idcontato`, `idfotos`, `nomeartistico`, `nome`, `dataNasc`, `sexo`, `etinia`, `nacionalidade`, `acendencia`, `atuacao`, `drt`, `profissao`, `cidatual`, `ufatual`, `cidadenatal`, `ufnatal`, `escolaridade`, `estadocivil`, `cur`, `fiel5`) VALUES
(77, 77, 77, 77, 'willian', 'fink', '1111-11-11', 'M', 'Branco', 'B', 'Europeu', 'estudande', 's', 'programador PHP', 'SP', 'SP', 'SP', 'SP', 'si', 'cas', 'PHP', 'meu curriculummmmmmmm\r\neswta aqui\r\n'),
(78, 78, 78, 78, 'nome', 'fink', '', 'M', '0', '0', '0', '', 's', '', '', '0', '', '0', '0', '0', '', '');
...
CREATE TABLE `enderecos` (
  ...
  `ufatua` varchar(50) NOT NULL,
  `endpri` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `enderecos` (`id`, `rua`, `complemento`, `cep`, `bairro`, `cidadeatual`, `ufatua`, `endpri`) VALUES
(77, 'martiniano machado cde borba, 306', '306', '04872030', 'jd recanto do sol', 'SP', 'SP', 's'),
(78, 'martiniano machado cde borba, 306', '306', '04872030', '', 'sp', '0', 's');
...
INSERT INTO `fotoscadastro` (`id`, `idfoto`, `url`) VALUES
(81, 77, 'e0223abe45a657887cfe3aadda2aefa1.jpg'),
(82, 77, 'd2483a8c6d2ff2d95e6f50dbf1745bfe.jpg'),
(83, 77, '1935833fa4a5ecde74095ead1a787746.jpg'),
(84, 77, 'a4120a75e53ba90239f237f1e0cf27d8.jpg'),
(85, 78, 'cc855bca1fe0954c99b0100967170c9b.jpg');
...
--
ALTER TABLE `dadospessoais`
  ADD CONSTRAINT `dadospessoais_ibfk_1` FOREIGN KEY (`idendereco`) REFERENCES `enderecos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `dadospessoais_ibfk_2` FOREIGN KEY (`idcontato`) REFERENCES `contatos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
